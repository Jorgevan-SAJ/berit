    ...
    return (
      <main style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#FAF6EF', fontFamily: "'Segoe UI', Roboto, Arial, sans-serif" }}>
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: 16, color: '#1F3A5F', marginBottom: 12 }}>Membro não encontrado.</div>
          <a href="/membros" style={{ color: '#1F3A5F', fontSize: 14 }}>Voltar para a lista de membros</a>
        </div>
      </main>
    )
  }
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#FAF6EF', fontFamily: "'Segoe UI', Roboto, Arial, sans-serif" }}>
      ...
      <div style={{ maxWidth: 560, margin: '0 auto', padding: '2rem 1.5rem' }}>
        ...
        <p style={{ fontSize: 14, color: '#8A8A8A', margin: '0 0 1.5rem' }}>Atualize os dados do membro.</p>
